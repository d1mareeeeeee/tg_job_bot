...
# Префильтр работает как чёрный список: в LLM уходит всё, кроме явного мусора.
# Поэтому «просто не вакансия» его пройдёт — нужен текст с рекламными стоп-словами.
NOT_VACANCY = (
    "Розыгрыш! Подпишитесь на канал и получите промокод на наш курс — "
    "разыгрываем три места среди новых подписчиков."
)
